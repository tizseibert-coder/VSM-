...
// Die VSM-Projektliste — bis 2026-09-17 der gesamte Inhalt von /dashboard,
// jetzt an eine eigene Adresse verschoben (docs/plan-company-overview-modules.md):
// /dashboard wird zur "smarten" Einstiegsseite, die fuer eine einfache
// Organisation genau diese Seite zeigt und fuer eine komplexe (mehr als ein
// Modul in Benutzung) eine Kachel-Uebersicht. Diese Seite selbst kennt den
// Unterschied nicht — sie ist unveraendert die VSM-Modul-Startseite, von wo
// auch immer man hierherkommt.
